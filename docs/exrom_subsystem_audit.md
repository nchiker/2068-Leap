...
The current V2 candidate uses `$3F0F/$4000` in Home ROM (241 bytes free)
and ends at `$DF4F` in EXROM (177 bytes free). The shared
program/array/scalar RAM pool is 15,180 bytes. These figures come from
