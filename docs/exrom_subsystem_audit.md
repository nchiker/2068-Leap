...
The current V2 candidate uses `$3F29/$4000` in Home ROM (215 bytes free)
and ends at `$DF9C` in EXROM (100 bytes free). The shared
program/array/scalar RAM pool is 1,847 bytes. These figures come from
